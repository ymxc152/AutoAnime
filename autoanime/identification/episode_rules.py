...
_MANUAL_SEASON_LAYOUT = {
    ...
    # BLEACH 千年血战篇（Thousand-Year Blood War）：每季 13 集，祸进谭为第 4 季（开放）
    # 不要用裸 'Bleach'/'死神' 做键：原作 BLEACH S04 会误走千年血战篇映射。
    '死神 千年血战篇-祸进谭': [(1, 13), (2, 13), (3, 13), (4, None)],
    '死神千年血战篇': [(1, 13), (2, 13), (3, 13), (4, None)],
    'BLEACH Sennen Kessen-hen': [(1, 13), (2, 13), (3, 13), (4, None)],
}
